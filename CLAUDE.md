...
```
scripts/main.gd       — scene root, _ready, _process, subsystem wiring, selfcheck
scripts/world_env.gd  — sky, lighting, day/night, tide, streetlights
scripts/world_geo.gd  — districts, causeways, sea, buildings
scripts/player.gd     — car (VehicleBody3D) + on-foot character, camera, enter/exit
scripts/weapons.gd    — raycast gun, firing, targets
